...
def engineer_features():
    ...
    for _, row in labeled_df.iterrows():
        ...
        try:
            ...
            print(f"Warning: Timestamp {timestamp} not found for {symbol}. Skipping setup.")
            continue
    ...
    features_df.dropna(inplace=True) # Drop rows where features could not be calculated
